...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd cusc_edx_api && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd cusc_edx_api && i18n_tool generate

detect_changed_source_translations:
	cd cusc_edx_api && i18n_tool changed
...
pull_translations:
	find cusc_edx_api/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/cusc_edx_api/cusc_edx_api/conf/locale:cusc_edx_api/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd cusc_edx_api && i18n_tool dummy
