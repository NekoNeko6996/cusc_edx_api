#!/usr/bin/env python
"""
Package metadata for cusc_edx_api.
"""
import os
import re
import sys
...
VERSION = get_version('cusc_edx_api', '__init__.py')
...
setup(
    ...
    author='Hoang Nam',
    author_email='lqm231231@gmail.om',
    url='https://github.com/nekoneko6996/cusc_edx_api',
    packages=find_packages(
        include=['cusc_edx_api', 'cusc_edx_api.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            # "tên_ghi_nhớ = python_path_đến_apps:ClassConfig"
            "cusc_edx_api = cusc_edx_api.apps:CuscEdxApiConfig",
        ],
        "cms.djangoapp": [
            # để trống cũng được
        ],
