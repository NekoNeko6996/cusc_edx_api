...
"""
cusc_edx_api documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'cusc_edx_api',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/nekoneko6996/cusc_edx_api",
...
#
# html_title = 'cusc_edx_api v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'cusc_edx_api'),
                os.path.join(root_path, 'cusc_edx_api/migrations')])
